	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-streetwear': 'linear-gradient(135deg, #8B5CF6 0%, #D946EF 50%, #F97316 100%)'
			},
			boxShadow: {
				'glass': '0 4px 30px rgba(0, 0, 0, 0.1)',
				'neon': '0 0 20px rgba(255, 255, 255, 0.5)',
				'product': '0px 10px 30px -5px rgba(0, 0, 0, 0.05)',
				'streetwear': '5px 5px 0px 0px rgba(0, 0, 0, 1)',
				'streetwear-dark': '5px 5px 0px 0px rgba(255, 255, 255, 0.8)',
			},
			backdropBlur: {
				'glass': 'blur(16px)'
			},
